...
--
-- Host: localhost
-- Generation Time: Apr 03, 2014 at 02:37 PM
...
--
-- Database: `rucstudytest`
--
CREATE DATABASE IF NOT EXISTS `rucstudytest` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `rucstudytest`;
...
CREATE TABLE `question` (
  ...
  `isexist` varchar(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`qno`),
  KEY `cno` (`cno`)
